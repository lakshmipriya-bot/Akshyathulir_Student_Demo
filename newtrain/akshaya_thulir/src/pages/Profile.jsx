      ...
      <Container maxWidth="lg" sx={{ py: 4 }}>
        ...
        >
          {isEditMode && !isEditable && (
            <Button
              variant="contained"
              sx={{ backgroundColor: "#1f4d3a", "&:hover": { backgroundColor: "#163d2e" } }}
              onClick={() => {
...
{showDeleteConfirm && (
  ...
  >
    <Card sx={{ p: 4, maxWidth: 400, width: "90%", border: "2px solid #c62828" }}>
      <Typography variant="h6" sx={{ mb: 1, fontWeight: "bold", color: "#c62828" }}>
        Confirm Delete
      </Typography>
...
<Box sx={{ display: "flex", gap: 2 }}>
  ...
  {/* 🗑️ Delete Button — only shown when a record exists and not in edit mode */}
  {isEditMode && !isEditable && (
    <Button
      variant="outlined"
      color="error"
